    ...
    return (
        <Wrapper ref={ref}>
            <ImageBelt ref={beltRef}>
                <img src={require("../../" + data.imagePath + "_ib1.png")} alt={data.title} />
                <img src={require("../../" + data.imagePath + "_ib2.png")} alt={data.title} />
                <img src={require("../../" + data.imagePath + "_ib3.png")} alt={data.title} />
                <img src={require("../../" + data.imagePath + "_ib4.png")} alt={data.title} />
                <img src={require("../../" + data.imagePath + "_ib5.png")} alt={data.title} />
            </ImageBelt>
        </Wrapper>
    )
});

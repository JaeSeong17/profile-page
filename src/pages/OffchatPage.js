...
const OffchatPage = () => {
    const splitTitle = "<div>" + detail[2].title.split("").join("</div><div>") + "</div>";
        ...
        <>
            ...
            <Responsive>
                <Wrapper>
                    ...
                    <div ref={subRef}>
                        <div><h2>{detail[2].subtitle}</h2></div>
                        <div><hr /></div>
                        <div><h4>{detail[2].summary}</h4></div>
                    </div>
                    <DetailPanel>
                        <ImageLotateBelt ref={beltRef} data={detail[2]} />
                        <DetailTextBox ref={textRef} data={detail[2]} />
                    </DetailPanel>
                </Wrapper>
            </Responsive>
            <Footer />
